...
//
// Verbatim copy of evm/abi/chainbills.ts, generated by evm/script/export-abi.mjs
// from IChainbills (the aggregate interface). Do not edit by hand: regenerate
// from evm/ when the contracts change, then copy here.
//
// Invariants:
//   - This is the only ABI the backend uses — no legacy mainAbi / gettersAbi.
//   - src/chains/abi/abi-sync.spec.ts fails when this copy differs from
//     evm/abi/chainbills.json (skipped when that file is absent, e.g. in Docker).
// ──────────────────────────────────────────────────────────────────────────────
