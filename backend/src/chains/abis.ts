// ──────────────────────────────────────────────────────────────────────────────
// Chainbills Backend — Chainbills contract ABIs
//
// Copied verbatim from relayer/src/utils/abis.ts (the reference implementation),
// which is generated from the compiled Foundry artifacts in evm/out/. Both
// exports are `as const` so viem infers argument/return types for every call
// and event. Do not hand-edit: regenerate from evm/ if the contracts change.
// ──────────────────────────────────────────────────────────────────────────────
...
export const gettersAbi = [
    ...
    outputs: [
      {
        ...
        components: [
          ...
          { name: 'timestamp', type: 'uint256', internalType: 'uint256' },
          { name: 'amount', type: 'uint256', internalType: 'uint256' },
          { name: 'payerPaymentId', type: 'bytes32', internalType: 'bytes32' },
        ],
      },
    ],
    stateMutability: 'view',
  ...
  { type: 'error', name: 'ChainbillsPayableChainIdMismatch', inputs: [] },
  ...
  { type: 'error', name: 'DuplicateTokenAndAmount', inputs: [] },
