...
/// @notice Setup script for configuring Wormhole on chains that do not support Circle CCTP.
contract SetupWormholeOnly is Script {
  function run() public {
    ...
    console.log('Setting up Wormhole-only on Chainbills ...');
    chainbills.setupWormholeOnly(wormhole, wormholeChainId, wormholeFinality, cbChainId);
