...
contract CbUtils is CbState {
  ...
  /// @param entity The associated entity hash.
  /// @param salt The entity type used as salt.
  /// @param count The sequential count for uniqueness.
  /// @return The generated bytes32 ID.
  ...
  /// @param payload The encoded payload to broadcast.
  /// @return sequence The published Wormhole sequence number.
